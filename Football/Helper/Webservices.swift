...
class WebServices: NSObject
{
    ...
    func CallGlobalAPI(url:String, headers:[String:String], parameters:NSDictionary, httpMethod:String, progressView:Bool, uiView:UIView, responseDict:@escaping (_ jsonResponce:JSON?, _ strErrorMessage:String) -> Void) {
