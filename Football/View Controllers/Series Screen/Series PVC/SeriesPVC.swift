...
class SeriesPVC: UIPageViewController {

    var tabDelegate: SeriesDelegate?
    ...
    private func generateArrVc() {
        var index = 0
        let vc1 = DomesticSeriesVC.instantiate(fromAppStoryboard: .Main)
        vc1.index = index
        arrVc.append(vc1)
        
        index += 1
        let vc2 = InternationalSeriesVC.instantiate(fromAppStoryboard: .Main)
        vc2.index = index
        arrVc.append(vc2)
        
        index += 1
        let vc3 = ClubFootballSeriesVC.instantiate(fromAppStoryboard: .Main)
        vc3.index = index
        arrVc.append(vc3)
