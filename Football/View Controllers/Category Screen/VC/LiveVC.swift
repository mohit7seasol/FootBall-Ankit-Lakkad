...
class LiveVC: UIViewController {
    ...
    private func setupCollectionView() {
        liveCollection.register(UINib(nibName: "MatchListCell", bundle: nil), forCellWithReuseIdentifier: "MatchListCell")
        liveCollection.delegate = self
        liveCollection.dataSource = self
        
        if let layout = liveCollection.collectionViewLayout as? UICollectionViewFlowLayout {
